...
public class BacteriaPage extends PurchasableCollectionPage{
	...
	protected String getEditCollectionPrefix() {
		return "edit_biocollections_bacterium_";
	}
	@Override
	protected String getImportXPath() {
		        
		return ".//*[@id='main-content']/div/div[1]/a[@href='/system/imports/new?class=Biocollections%3A%3ABacterium']";
	}

	@Override
	protected String getFileNameToImport() {
		
		return LGConstants.BACTERIA_TEMPLATE;
	}
	...
	public List<String> getAvailableColumnsForCustomiseTableView() {
		...
		columns.add("preferences_sensitivity");
